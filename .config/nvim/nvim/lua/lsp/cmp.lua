...
--vim.cmd("autocmd FileType guihua lua require('cmp').setup.buffer { enabled = true }")
--vim.cmd("autocmd FileType guihua_rust lua require('cmp').setup.buffer { enabled = true }")
--
...
cmp_config = {
  ...
  formatting = {
    ...
    format = function(entry, vim_item)
      ...
      --        cmp_config.formatting.kind_icons[vim_item.kind],
      --        vim_item.kind)
      vim_item.menu = cmp_config.formatting.source_names[entry.source.name]
      vim_item.dup = cmp_config.formatting.duplicates[entry.source.name]
          or cmp_config.formatting.duplicates_default
